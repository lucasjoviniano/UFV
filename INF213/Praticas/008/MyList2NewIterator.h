...
public:
	...
	int size();// {return -1; /*etapa 2: implemente esta funcao sem usar o membro de dados dataSize*/ } // na STL List, a funcao size() calcula o tamanho da lista dinamicamente (exercicio: qual a ordem de complexidade?)
...
public:
	MyList2Iterator(Node<T> *ptr_, MyList2<T> *p): ptr(ptr_), l(p) {}
